...
import com.fei.netty.springmvc.http.CookieAdapter;
import com.fei.netty.springmvc.http.DefaultHttpServletRequest;
import com.fei.netty.springmvc.http.DefaultHttpServletResponse;
import com.fei.netty.springmvc.http.HttpUtils;
...
import com.fei.netty.springmvc.log.InterfaceLog;
...
public class HttpServerHandler extends ChannelHandlerAdapter {
	...
	public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception { 
		if(msg instanceof DefaultFullHttpRequest){
			...
			DefaultHttpServletResponse response = new DefaultHttpServletResponse() ;
	...
	private HttpServletRequest getServletRequest(DefaultFullHttpRequest nettyRequest) {
		DefaultHttpServletRequest request = new DefaultHttpServletRequest(dispatcherServlet.getServletContext(),nettyRequest.getMethod().name(),nettyRequest.getUri()) ;
