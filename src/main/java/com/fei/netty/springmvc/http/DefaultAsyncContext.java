...
public class DefaultAsyncContext implements AsyncContext{
	...
	public boolean hasOriginalRequestAndResponse() {
		return (this.request instanceof DefaultHttpServletRequest && this.response instanceof DefaultHttpServletResponse);
	}
	...
	public void complete() {
		if(request != null && request instanceof DefaultHttpServletRequest){
			DefaultHttpServletRequest httpServletRequest = (DefaultHttpServletRequest)request ;
			httpServletRequest.setAsyncStarted(false);
		}
//		DefaultHttpServletRequest mockRequest = WebUtils.getNativeRequest(request, HttpServletRequest.class);
//		if (mockRequest != null) {
