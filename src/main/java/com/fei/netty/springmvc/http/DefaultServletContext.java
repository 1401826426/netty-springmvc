...
public class DefaultServletContext implements ServletContext{
	...
	private final SessionCookieConfig sessionCookieConfig = new DefaultSessionCookieConfig();
	 ...
	 * @see org.springframework.core.io.DefaultResourceLoader
	 */
	public DefaultServletContext(String resourceBasePath) {
	 ...
	 */
	public DefaultServletContext(ResourceLoader resourceLoader) {
		this("", resourceLoader);
	}
	 ...
	 */
	public DefaultServletContext(String resourceBasePath, ResourceLoader resourceLoader) {
		...
		registerNamedDispatcher(this.defaultServletName, new DefaultRequestDispatcher(this.defaultServletName));
	}
